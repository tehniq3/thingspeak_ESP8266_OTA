...
#define DHTPIN 4 // GPIO4 - D2 - https://randomnerdtutorials.com/esp8266-pinout-reference-gpios/

//DHT dht(DHTPIN, DHT22,18);  // // for ESP8266
//DHT dht(DHTPIN, DHT11,15);  // // for ESP8266
...
//dht.begin();
 // Autodetect is not working reliable, don't use the following line
  // dht.setup(17);
  // use this instead: 
  dht.setup(DHTPIN, DHTesp::DHT11); // Connect DHT sensor to GPIOxx
